(function($) {
	...
	var CreditsPopup = this.CreditsPopup = Popup.extend({
		...
		initialize: function() {
			...
			buf += '<h2>Server Owner</h2>';
			buf += '<ul><li><p><a href="http://oiawesome.github.io/charizards" target="_blank" class="subtle"><strong>Aaron Ayenew</strong> [Monte Crist0]</a> <small>&ndash; Development of server</small></p></li></ul>';
            buf += '<h2>Showdown Dev Staff</h2>';
